    ...
    <div className="mx-auto w-full max-w-7xl space-y-5 p-4 sm:space-y-6 sm:p-6">
      <section className="-mx-4 px-4 py-4 sm:-mx-6 sm:px-6 sm:py-5">
        <div className="space-y-3">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-950">Audit / Activity Logs</h1>
            <p className="text-sm text-slate-500">Review admin actions, filter events, and inspect the current audit history.</p>
          </div>
          <ClubAdminNav />
        </div>
      </section>
