    ...
    <div className="mx-auto w-full max-w-7xl space-y-5 p-4 sm:space-y-6 sm:p-6">
      <section className="-mx-4 px-4 py-4 sm:-mx-6 sm:px-6 sm:py-5">
        <div className="space-y-3">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-950">Club Admin Dashboard</h1>
            <p className="text-sm text-slate-500">Tenant-wide view for users, teams, access requests, and readiness state.</p>
          </div>
          <ClubAdminNav />
        </div>
      </section>
